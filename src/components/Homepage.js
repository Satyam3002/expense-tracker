...
function HomePage() {
  ...
  const pieChartData = {
    ...
    datasets: [
      {
        data: Object.values(expenseCategories).length > 0 ? Object.values(expenseCategories) : [1],
        backgroundColor: Object.values(expenseCategories).length > 0 
          ? [
              'rgba(255, 99, 132, 0.5)',
              'rgba(54, 162, 235, 0.5)',
              'rgba(75, 192, 192, 0.5)',
        ...
        borderColor: Object.values(expenseCategories).length > 0 
          ? [
              'rgba(255, 99, 132, 1)',
              'rgba(54, 162, 235, 1)',
              'rgba(75, 192, 192, 1)',
